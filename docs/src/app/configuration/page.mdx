...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>AGENT_BROWSER_DASHBOARD_ALLOWED_ORIGINS</code></td><td>Comma-separated exact <code>http(s)</code> origins allowed for a reverse-proxied dashboard. Loopback origins are always accepted.</td><td>(none)</td></tr>
