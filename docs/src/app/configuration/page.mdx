...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>isolateContext</code></td><td><code>--isolate-context</code></td><td>boolean</td></tr>
...
This applies to boolean flags such as `--headed`, `--debug`, `--json`, `--ignore-https-errors`, `--allow-file-access`, `--hide-scrollbars`, `--auto-connect`, `--isolate-context`, `--annotate`, `--content-boundaries`, `--confirm-interactive`, and `--no-auto-dialog`.
